...
#---------------------------------------------------------------
#---------------------------------------------------------------         ,
API_ID = int(environ.get('API_ID', '28521386'))
API_HASH = environ.get('API_HASH', '9788675703f0e404f0424c1aab84fbfb')
BOT_TOKEN = environ.get('BOT_TOKEN', '')
#---------------------------------------------------------------
#---------------------------------------------------------------
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5665677555').split()]
USERNAME = environ.get('USERNAME', "https://t.me/nh_killer") # ADMIN USERNAME
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002265381777'))
MOVIE_GROUP_LINK = environ.get('MOVIE_GROUP_LINK', 'https://t.me/+O5j4WcdeULxiNTZl')
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002190681742').split()]

#---------------------------------------------------------------
#---------------------------------------------------------------
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://mdnazbul:<7324896787>@cluster0.ayuev.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
DATABASE_NAME = environ.get('DATABASE_NAME', "mdnazbul")
